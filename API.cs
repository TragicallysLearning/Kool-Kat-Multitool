            ...
            try
            {
                ...
                switch (response[2])
                {
                    ...
                    case "binderror":
                        ...
                        return;
                    case "banned":
                        System.Windows.Forms.MessageBox.Show("This application has been banned for violating the TOS" + Environment.NewLine + "Contact us at support@auth.gg", Name, System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                        Process.GetCurrentProcess().Kill();
                        return;
                }
                Security.End();
...
internal class API
{
    public static void Log(string username, string action)
    {
        ...
        {
            System.Windows.Forms.MessageBox.Show("Missing log information!", ApplicationSettings.Name, System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
            Process.GetCurrentProcess().Kill();
        }
        string[] response = new string[] { };
        using (WebClient wc = new WebClient())
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Failed to establish a secure SSL tunnel with the server!", OnProgramStart.Name, System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                Process.GetCurrentProcess().Kill();
            }
        }
    }
...
internal class Security
{
    ...
    public static void Start()
    {
        ...
        {
            System.Windows.Forms.MessageBox.Show("A session has already been started, please end the previous one!", OnProgramStart.Name, System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Warning);
            Process.GetCurrentProcess().Kill();
        }
        else
        {
            using (StreamReader sr = new StreamReader(@"C:\Windows\System32\drivers\etc\hosts"))
            {
                ...
                {
                    Constants.Breached = true;
                    System.Windows.Forms.MessageBox.Show("DNS redirecting has been detected!", OnProgramStart.Name, System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                    Process.GetCurrentProcess().Kill();
                }
            }
    ...
    public static void End()
    {
        if (!Constants.Started)
        {
            System.Windows.Forms.MessageBox.Show("No session has been started, closing for security reasons!", OnProgramStart.Name, System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Warning);
            Process.GetCurrentProcess().Kill();
        }
        else
        {
...
class InfoManager
{
    ...
    private void OnCallBack()
    {
        ...
        {
            Constants.Breached = true;
            System.Windows.Forms.MessageBox.Show("ARP Cache poisoning has been detected!", OnProgramStart.Name, System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
            Process.GetCurrentProcess().Kill();
        }
        else
        {
